...
//        setLocationRelativeTo(null);
    ...
    private void init() {
        ...
        imgPanel1.setImgPath("12.jpg");
        imgPanel1.setBounds(155, 160, 700, 500);
        numberLabel = new JLabel();
        numberLabel.setBounds(310, 360, 220, 40);
...
class ShadePanel1 extends JPanel {
    ...
    protected void paintComponent(Graphics g1) {
        ...
        //创建填充模式对象
        GradientPaint paint = new GradientPaint(0, 0, Color.LIGHT_GRAY, 0, height, Color.white);
        g.setPaint(paint);
